Except for data processing code, neither generators nor repo creators
...
- ./yassour2009/
  This contains original files of Yassour et.al. (2009) and includes 6577 ORFs
  and six experimens.
...
- ./yeast_s288c/
  This is original yeast s288c file from S. cerevisiae Genome Database
  at http://www.yeastgenome.org/ and includes 5530 ORFs.
...
- Gilchrist M, Chen WC, Shah P, Zaretzki R (2014) Estimating gene
  expression and codon specific translational efficiencies, mutation
  biases, and selection coefficients from genomic data. bioRxiv, 009670.
